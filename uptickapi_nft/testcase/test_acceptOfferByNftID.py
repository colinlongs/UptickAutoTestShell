...
ex=excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","offer列表")
cases=ex.read_data()


@ddt
class TestacceptOfferByNftID(unittest.TestCase):
    @list_data(cases)
    def test_acceptOfferByNftID(self,item):

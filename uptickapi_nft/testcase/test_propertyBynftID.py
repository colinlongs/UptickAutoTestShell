...
ex=excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","属性")
cases=ex.read_data()


@ddt
class TestpropertyBynftID(unittest.TestCase):
    @list_data(cases)
    def test_propertyBynftID(self,item):

...
ex = excelutils.HandleExcel(
    r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx", "关注")
cases = ex.read_data()


@ddt
class Testaddfans(unittest.TestCase):
    @list_data(cases)
    def test_getaddfans(self, item):

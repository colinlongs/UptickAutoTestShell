...
ex=excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","详情页推荐资产")
cases=ex.read_data()


@ddt
class TestrecommendListBynftID(unittest.TestCase):
    @list_data(cases)
    def test_recommendListBynftID(self,item):

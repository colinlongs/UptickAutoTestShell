...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","兑换信息")
cases=ex.read_data()

@ddt
class Testexchangeinfo(unittest.TestCase):
    @list_data(cases)
    def test_exchangeinfo(self,item):

...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","他人offer列表")
cases=ex.read_data()

@ddt
class TestmyOffer(unittest.TestCase):
    @list_data(cases)
    def test_myOffer(self,item):

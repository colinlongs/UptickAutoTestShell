...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","集合资产列表")
cases=ex.read_data()

@ddt
class Testgetmarketlist(unittest.TestCase):
    @list_data(cases)
    def test_getmarketlist(self,item):

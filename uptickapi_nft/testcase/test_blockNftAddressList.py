...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","锁定集合列表")
cases=ex.read_data()

@ddt
class TestblockNftAddressList(unittest.TestCase):
    @list_data(cases)
    def test_getblockNftAddressList(self,item):

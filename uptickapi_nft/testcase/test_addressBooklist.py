...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","联系人")
cases=ex.read_data()

@ddt
class Testaddressbook(unittest.TestCase):
    @list_data(cases)
    def test_addressbook(self,item):

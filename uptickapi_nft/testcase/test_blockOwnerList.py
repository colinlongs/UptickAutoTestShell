...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","锁定创作者列表")
cases=ex.read_data()

@ddt
class TestblockOwnerList(unittest.TestCase):
    @list_data(cases)
    def test_getblockOwnerList(self,item):

...
ex = excelutils.HandleExcel(
    r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx", "提醒消息")
cases = ex.read_data()


@ddt
class TestsysMsg(unittest.TestCase):
    @list_data(cases)
    def test_sysMsg(self, item):

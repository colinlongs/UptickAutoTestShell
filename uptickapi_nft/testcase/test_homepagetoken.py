...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","他人主页资产")
cases=ex.read_data()

@ddt
class Testhomepagetoken(unittest.TestCase):
    @list_data(cases)
    def test_gethomepagetoken(self,item):

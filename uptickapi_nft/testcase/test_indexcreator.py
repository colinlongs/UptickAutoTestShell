...
ex=excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","推荐创作者")
cases=ex.read_data()
...
class Testindexcreator(unittest.TestCase):
    @list_data(cases)
    def test_01_indexcreator(self,item):

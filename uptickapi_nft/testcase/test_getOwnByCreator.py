...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","创建者筛选")
cases=ex.read_data()

@ddt
class TestgetOwnByCreator(unittest.TestCase):
    @list_data(cases)
    def test_getOwnByCreator(self,item):

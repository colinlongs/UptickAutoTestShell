...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","兑换列表")
cases=ex.read_data()

@ddt
class TestexchangeList(unittest.TestCase):
    @list_data(cases)
    def test_exchangeList(self,item):

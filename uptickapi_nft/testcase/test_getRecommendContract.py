...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","推荐集合")
cases=ex.read_data()

@ddt
class Testrecommendcontract(unittest.TestCase):
    @list_data(cases)
    def test_getreommendcontract(self,item):

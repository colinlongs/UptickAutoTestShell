...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","奖券列表")
cases=ex.read_data()

@ddt
class TestjoinListByOwner(unittest.TestCase):
    @list_data(cases)
    def test_getjoinListByOwner(self,item):

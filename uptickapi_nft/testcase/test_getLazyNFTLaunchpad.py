...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","懒铸造列表")
cases=ex.read_data()

@ddt
class TestgetLazyNFTLaunchpad(unittest.TestCase):
    @list_data(cases)
    def test_getLazyNFTLaunchpad(self,item):

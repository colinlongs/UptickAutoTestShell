...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","用户信息")
cases=ex.read_data()

@ddt
class Testuserinfo(unittest.TestCase):
    @list_data(cases)
    def test_userinfo(self,item):
        ...
        try:
            ...
            if expect["code"] in result:
                self.assertEqual(expect["id"],result["data"]["id"])

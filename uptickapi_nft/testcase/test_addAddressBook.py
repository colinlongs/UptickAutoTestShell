...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","添加联系人")
cases=ex.read_data()

@ddt
class TestaddAddressBook(unittest.TestCase):
    @list_data(cases)
    def test_addAddressBook(self,item):

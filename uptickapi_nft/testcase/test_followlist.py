...
ex= excelutils.HandleExcel(r"/Users/starrymedia/PycharmProjects/upticknetwork/uptickapi_nft/testcase/api_testcase.xlsx","收藏列表")
cases=ex.read_data()

@ddt
class Testfollowlist(unittest.TestCase):
    @list_data(cases)
    def test_getfollowlist(self,item):
